...
public class CombosDAO {
    ...
    public void popularCombo(String tabela, JComboBox combo) {
        ...
        item.setCodigo(0);
        item.setDescricao("Selecione Abaixo");
        combo.addItem(item);
        ...
        try {
            ...
            if (resultado.isBeforeFirst()) {
                while (resultado.next()) {
                    item = new ComboItem();
                    item.setCodigo(resultado.getInt(1)); //OBS: A NUMERAÇÃO DE UM OBJETO RESULTSET, COMEÇA EM 1 E NÃO EM 0 COMO EM ÍNDICES COMUMENTE USADOS!!!
